function GlHelper(canvas, options) {
    this.canvas = canvas;
    //this.gl = WebGLDebugUtils.makeDebugContext(canvas.getContext("webgl", options || {}) || canvas.getContext("experimental-webgl", options || {}));
...
GlHelper.prototype.loadTextureDOM = function(id) {
